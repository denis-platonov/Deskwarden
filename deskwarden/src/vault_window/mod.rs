...
///
/// That was a convention until
/// `nothing_but_gated_test_modules_lives_below_the_guards_cut` (the last
/// module in this file) made it a check: it walks everything below the cut
/// and fails on anything that is not a gated test module, in either
/// direction -- a production item appended down here, or the marker matched
/// early in a comment.
#[cfg(test)]
